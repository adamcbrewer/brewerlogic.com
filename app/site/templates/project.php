    ...
    <article class="section section--alt project">
        ...
        <section class="contain project-images">
            ...
            <?php foreach ($page->images()->sortBy('sort', 'asc')->not('thumb.jpg', 'thumb.png', 'feature.jpg', 'feature.png') as $image) : ?>
                ...
                <div class="contain contain--text figure-description figure-description--above"><?php echo kirbyText($image->description()) ?></div>
                <?php endif; ?>
                ...
                <div class="contain contain--text figure-description figure-description--below"><?php echo kirbyText($image->description()) ?></div>
                <?php endif; ?>
