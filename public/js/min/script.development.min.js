/*!
 * brewerlogic - 1.0.0 - 2013-07-24 21:26:44
 * Development Build
...
var Zepto = function() {
    ...
    function p(t) {
        var e, n;
        return A[t] || (e = O.createElement(t), O.body.appendChild(e), n = M(e, "").getPropertyValue("display"), 
        e.parentNode.removeChild(e), "none" == n && (n = "block"), A[t] = n), A[t];
    }
    function d(t) {
        return "children" in t ? S.call(t.children) : E.map(t.childNodes, function(t) {
            return 1 == t.nodeType ? t : x;
        });
    }
    function m(t, e, n) {
        for (C in e) n && (s(e[C]) || r(e[C])) ? (s(e[C]) && !s(t[C]) && (t[C] = {}), r(e[C]) && !r(t[C]) && (t[C] = []), 
        m(t[C], e[C], n)) : e[C] !== x && (t[C] = e[C]);
    }
    function v(t, e) {
    ...
    function $(t, e) {
        e(t);
        for (var n in t.childNodes) $(t.childNodes[n], e);
    }
    var x, C, E, T, k, N, j = [], S = j.slice, P = j.filter, O = window.document, A = {}, D = {}, M = O.defaultView.getComputedStyle, _ = {
        "column-count": 1,
        columns: 1,
        "font-weight": 1,
        "line-height": 1,
        ...
        "z-index": 1,
        zoom: 1
    }, Z = /^\s*<(\w+|!)[^>]*>/, q = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, R = /^(?:body|html)$/i, L = [ "val", "css", "html", "text", "data", "width", "height", "offset" ], z = [ "after", "prepend", "before", "append" ], H = O.createElement("table"), B = O.createElement("tr"), W = {
        ...
        th: B,
        "*": O.createElement("div")
    }, F = /complete|loaded|interactive/, I = /^\.([\w-]+)$/, V = /^#([\w-]*)$/, Q = /^[\w-]+$/, U = {}, J = U.toString, X = {}, Y = O.createElement("div");
    return X.matches = function(t, e) {
        if (!t || 1 !== t.nodeType) return !1;
        var n = t.webkitMatchesSelector || t.mozMatchesSelector || t.oMatchesSelector || t.matchesSelector;
        if (n) return n.call(t, e);
        var i, o = t.parentNode, s = !o;
        return s && (o = Y).appendChild(t), i = ~X.qsa(o, e).indexOf(t), s && Y.removeChild(t), 
        i;
    }, k = function(t) {
        ...
        t.replace && (t = t.replace(q, "<$1></$2>")), e === x && (e = Z.test(t) && RegExp.$1), 
        e in W || (e = "*");
        var i, o, r = W[e];
        return r.innerHTML = "" + t, o = E.each(S.call(r.childNodes), function() {
            r.removeChild(this);
        }), s(n) && (i = E(o), E.each(n, function(t, e) {
        ...
        if (t) {
            ...
            if (X.isZ(t)) return t;
            var i;
            if (r(t)) i = c(t); else if (o(t)) i = [ s(t) ? E.extend({}, t) : t ], t = null; else if (Z.test(t)) i = X.fragment(t.trim(), RegExp.$1, n), 
            t = null; else {
        ...
        var n;
        return i(t) && V.test(e) ? (n = t.getElementById(RegExp.$1)) ? [ n ] : [] : 1 !== t.nodeType && 9 !== t.nodeType ? [] : S.call(I.test(e) ? t.getElementsByClassName(RegExp.$1) : Q.test(e) ? t.getElementsByTagName(e) : t.querySelectorAll(e));
    }, E.contains = function(t, e) {
        return t !== e && t.contains(e);
    }, E.type = t, E.isFunction = e, E.isWindow = n, E.isArray = r, E.isPlainObject = s, 
    E.isEmptyObject = function(t) {
    ...
    }, E.camelCase = k, E.trim = function(t) {
        return null == t ? "" : String.prototype.trim.call(t);
    }, E.uuid = 0, E.support = {}, E.expr = {}, E.map = function(t, e) {
        var n, i, o, s = [];
        if (a(t)) for (i = 0; t.length > i; i++) n = e(t[i], i), null != n && s.push(n); else for (o in t) n = e(t[o], o), 
        null != n && s.push(n);
        return u(s);
    }, E.each = function(t, e) {
        var n, i;
        ...
        ready: function(t) {
            return F.test(O.readyState) ? t(E) : O.addEventListener("DOMContentLoaded", function() {
                t(E);
            }, !1), this;
        },
        get: function(t) {
            return t === x ? S.call(this) : this[t >= 0 ? t : t + this.length];
        },
        toArray: function() {
            return this.get();
        },
        ...
        not: function(t) {
            ...
            if (e(t) && t.call !== x) this.each(function(e) {
                ...
                var i = "string" == typeof t ? this.filter(t) : a(t) && e(t.item) ? S.call(t) : E(t);
        ...
        find: function(t) {
            ...
            }) : 1 == this.length ? E(X.qsa(this[0], t)) : this.map(function() {
                return X.qsa(this, t);
            });
        },
        closest: function(t, e) {
            var n = this[0], o = !1;
            for ("object" == typeof t && (o = E(t)); n && !(o ? o.indexOf(n) >= 0 : X.matches(n, t)); ) n = n !== e && !i(n) && n.parentNode;
            return E(n);
        },
        parents: function(t) {
        ...
        wrapInner: function(t) {
            var n = e(t);
            return this.each(function(e) {
                var i = E(this), o = i.contents(), s = n ? t.call(this, e) : t;
        ...
        attr: function(t, e) {
            ...
            return "string" == typeof t && e === x ? 0 == this.length || 1 !== this[0].nodeType ? x : "value" == t && "INPUT" == this[0].nodeName ? this.val() : !(n = this[0].getAttribute(t)) && t in this[0] ? this[0][t] : n : this.each(function(n) {
                if (1 === this.nodeType) if (o(t)) for (C in t) y(this, C, t[C]); else y(this, t, g(this, e, n, this.getAttribute(t)));
            });
        },
        ...
        offset: function(t) {
            if (t) return this.each(function(e) {
                var n = E(this), i = g(this, t, e, n.offset()), o = n.offsetParent().offset(), s = {
                    top: i.top - o.top,
                    left: i.left - o.left
                };
        ...
        css: function(e, n) {
            if (2 > arguments.length && "string" == typeof e) return this[0] && (this[0].style[k(e)] || M(this[0], "").getPropertyValue(e));
            var i = "";
            if ("string" == t(e)) n || 0 === n ? i = l(e) + ":" + f(e, n) : this.each(function() {
                this.style.removeProperty(l(e));
            }); else for (C in e) e[C] || 0 === e[C] ? i += l(C) + ":" + f(C, e[C]) + ";" : this.each(function() {
        ...
        hasClass: function(t) {
            return j.some.call(this, function(t) {
        ...
        removeClass: function(t) {
            return this.each(function(e) {
                return t === x ? w(this, "") : (T = w(this), g(this, t, e, T).split(/\s+/g).forEach(function(t) {
                    T = T.replace(h(t), " ");
                }), w(this, T.trim()), x);
            });
        },
        toggleClass: function(t, e) {
            return this.each(function(n) {
                var i = E(this), o = g(this, t, n, w(this));
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var t = this.offsetParent || O.body; t && !R.test(t.nodeName) && "static" == E(t).css("position"); ) t = t.offsetParent;
                return t;
            });
        }
    }, E.fn.detach = E.fn.remove, [ "width", "height" ].forEach(function(t) {
        E.fn[t] = function(e) {
            var o, s = this[0], r = t.replace(/./, function(t) {
                return t[0].toUpperCase();
            });
            return e === x ? n(s) ? s["inner" + r] : i(s) ? s.documentElement["offset" + r] : (o = this.offset()) && o[t] : this.each(function(n) {
        ...
        var i = n % 2;
        E.fn[e] = function() {
            var e, o, s = E.map(arguments, function(n) {
            ...
            return 1 > s.length ? this : this.each(function(t, e) {
                ...
                s.forEach(function(t) {
                    if (r) t = t.cloneNode(!0); else if (!o) return E(t).remove();
                    $(o.insertBefore(t, e), function(t) {
    ...
    }), X.Z.prototype = E.fn, X.uniq = N, X.deserializeValue = b, E.zepto = X, E;
}();
...
window.Zepto = Zepto, "$" in window || (window.$ = Zepto), function(t) {
    ...
    function n(t, n, s, r) {
        ...
        return (f[e(t)] || []).filter(function(t) {
            return !(!t || n.e && t.e != n.e || n.ns && !a.test(t.ns) || s && e(t.fn) !== e(s) || r && t.sel != r);
        });
    }
    function i(t) {
        var e = ("" + t).split(".");
    ...
    function c(n, o, c, u, l, h) {
        var p = e(n), d = f[p] || (f[p] = []);
        s(o, c, function(e, o) {
            var s = i(e);
            s.fn = o, s.sel = u, s.e in m && (o = function(e) {
            ...
            }, s.i = d.length, d.push(s), n.addEventListener(a(s.e), s.proxy, r(s, h));
        });
    }
    function u(t, i, o, c, u) {
        var l = e(t);
        s(i || "", o, function(e, i) {
            n(t, e, i, c).forEach(function(e) {
                delete f[l][e.i], t.removeEventListener(a(e.e), e.proxy, r(e, u));
            });
        });
    }
    function l(e) {
    ...
    t.fn.delegate = function(e, n, i) {
        return this.each(function(o, s) {
            c(s, n, i, e, function(n) {
                return function(i) {
                    var o, r = t(i.target).closest(e, s).get(0);
                    return r ? (o = t.extend(l(i), {
                        currentTarget: r,
                        liveFired: s
                    }), n.apply(r, [ o ].concat([].slice.call(arguments, 1)))) : void 0;
                };
            });
        });
        ...
        return this.each(function(r, a) {
            o = l("string" == typeof e ? t.Event(e) : e), o.data = i, o.target = a, t.each(n(a, e.type || e), function(t, e) {
                return s = e.proxy(o), o.isImmediatePropagationStopped() ? !1 : void 0;
            });
        }), s;
    ...
    function r(t, e, i) {
        var o = i.context, s = "success";
        i.success.call(o, t, s, e), n(i, o, "ajaxSuccess", [ e, i, t ]), c(s, e, i);
    }
    function a(t, e, i, o) {
        var s = o.context;
        o.error.call(s, i, e, t), n(o, s, "ajaxError", [ i, o, t ]), c(e, i, o);
    }
    function c(t, e, i) {
        var s = i.context;
        i.complete.call(s, e, t), n(i, s, "ajaxComplete", [ e, i ]), o(i);
    }
    function u() {}
    function l(t) {
        return t && (t = t.split(";", 2)[0]), t && (t == C ? "html" : t == x ? "json" : b.test(t) ? "script" : $.test(t) && "xml") || "text";
    }
    function h(t, e) {
    ...
    function d(e, n, i, o) {
        ...
        t.each(n, function(n, a) {
            s = t.type(a), o && (n = i ? o : o + "[" + (r ? "" : n) + "]"), !o && r ? e.add(a.name, a.value) : "array" == s || !i && "object" == s ? d(e, a, i, n) : e.add(n, a);
        });
    }
    var m, v, g = 0, y = window.document, w = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, b = /^(?:text|application)\/javascript/i, $ = /^(?:text|application)\/xml/i, x = "application/json", C = "text/html", E = /^\s*$/;
    t.active = 0, t.ajaxJSONP = function(e) {
        if (!("type" in e)) return t.ajax(e);
        var n, i = "jsonp" + ++g, o = y.createElement("script"), c = function() {
        ...
        n.url || (n.url = "" + window.location), f(n), n.cache === !1 && (n.url = h(n.url, "_=" + Date.now()));
        var o = n.dataType, c = /=\?/.test(n.url);
        if ("jsonp" == o || c) return c || (n.url = h(n.url, "callback=?")), t.ajaxJSONP(n);
        var p, d = n.accepts[o], g = {}, y = /^([\w-]+:)\/\//.test(n.url) ? RegExp.$1 : window.location.protocol, w = n.xhr();
        n.crossDomain || (g["X-Requested-With"] = "XMLHttpRequest"), d && (g.Accept = d, 
        d.indexOf(",") > -1 && (d = d.split(",", 2)[0]), w.overrideMimeType && w.overrideMimeType(d)), 
        ...
        n.headers = t.extend(g, n.headers || {}), w.onreadystatechange = function() {
            if (4 == w.readyState) {
                w.onreadystatechange = u, clearTimeout(p);
                var e, i = !1;
                if (w.status >= 200 && 300 > w.status || 304 == w.status || 0 == w.status && "file:" == y) {
                    o = o || l(w.getResponseHeader("content-type")), e = w.responseText;
                    try {
                        "script" == o ? (1, eval)(e) : "xml" == o ? e = w.responseXML : "json" == o && (e = E.test(e) ? null : t.parseJSON(e));
                    } catch (s) {
                        i = s;
                    }
                    i ? a(i, "parsererror", w, n) : r(e, w, n);
                } else a(null, w.status ? "error" : "abort", w, n);
            }
        };
        var b = "async" in n ? n.async : !0;
        w.open(n.type, n.url, b);
        for (v in n.headers) w.setRequestHeader(v, n.headers[v]);
        return s(w, n) === !1 ? (w.abort(), !1) : (n.timeout > 0 && (p = setTimeout(function() {
            w.onreadystatechange = u, w.abort(), a(null, "timeout", w, n);
        ...
        var o, s = this, r = e.split(/\s/), a = p(e, n, i), c = a.success;
        return r.length > 1 && (a.url = r[0], o = r[1]), a.success = function(e) {
            s.html(o ? t("<div>").html(e.replace(w, "")).find(o) : e), c && c.apply(s, arguments);
        }, t.ajax(a), this;
    };
